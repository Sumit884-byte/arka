...
<CardGroup cols={2}>
  ...
  <Card title="Quickstart" icon="rocket" href="/quickstart">Fresh install checklist</Card>
  <Card title="CLI reference" icon="terminal" href="/guides/cli">`arka doctor` and diagnostics</Card>
</CardGroup>
