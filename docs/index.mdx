...
description: "Install Arka, connect it to Cursor over MCP, and use local terminal skills. Start at Quickstart."
...
Use the sidebar tabs: **Get Started**, **Guides**, **Concepts**, and **Reference**. Switch language for 中文 or हिंदी.
