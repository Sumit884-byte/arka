...
DuckDuckGo lookups honor two env vars. Chat continues gracefully if web-context gathering fails: on timeout or repeated errors, the search error is logged and the answer falls back to model knowledge instead of stalling the reply.
