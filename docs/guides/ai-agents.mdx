...
This page is for **AI agents** that call Arka over MCP (Cursor, Claude Desktop, Codex, and similar). Humans can skim it; install steps are in [MCP integration](/guides/mcp).

To find other docs pages, start at [llms.txt](/llms.txt). Fetch one page. Append `.md` for Markdown.
