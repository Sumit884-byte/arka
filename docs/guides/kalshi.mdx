...
| Command | Description |
| --- | --- |
| `arka kalshi search <keywords>` | Search open markets by title/ticker keyword |
| `arka kalshi market <TICKER>` | Full quote for one market (YES/NO, volume, close time) |
| `arka kalshi trending` | Top open markets by 24h volume |
