...
Routing is strict — generic questions like _symptoms of diabetes_ stay on `web_answer`. Professions activate on explicit role mention or saved memory \+ keywords.
