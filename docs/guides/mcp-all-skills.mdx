...
<Note>
  **AI agents:** Read the dedicated [AI agent guide](/guides/ai-agents) first — routing table, execution rules, and session flow. This page covers dispatch-backed skills and opt-in personal tools.
</Note>
