...
| Command | Description |
| --- | --- |
| `arka route_learn list` | List all learned routes |
| `arka route_learn delete <id-or-phrase>` | Remove a route |
| `arka route_learn test <phrase>` | Preview what a phrase would run |
