...
<CardGroup cols={2}>
  <Card title="Skills catalog" icon="puzzle-piece" href="/guides/skills">All routable skills</Card>
  <Card title="CLI reference" icon="terminal" href="/guides/cli">`arka route` and `agent_route`</Card>
  <Card title="Plugins" icon="plug" href="/guides/plugins">Third-party triggers</Card>
  <Card title="Aliases" icon="list" href="/reference/aliases">Command and skill synonyms</Card>
</CardGroup>
