...
Arka MCP client भी है और MCP server भी। Config: `~/.config/arka/mcp.json`। शुरू करें: `arka mcp list`, `arka mcp add`, `arka mcp tools`, `arka mcp call`। Tool routing: [AI agent guide](/hi/guides/ai-agents)। IDE: [Arka के साथ code कैसे लिखें](/hi/guides/code-with-arka)।
