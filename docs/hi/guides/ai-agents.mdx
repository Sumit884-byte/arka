...
यह पेज **AI agents** (Cursor, Claude Desktop, Codex, Cline, Windsurf, आदि) के लिए लिखा गया है जो Model Context Protocol पर Arka को call करते हैं। मनुष्य भी इसे skim कर सकते हैं; setup details [MCP integration](/hi/guides/mcp) में हैं।
