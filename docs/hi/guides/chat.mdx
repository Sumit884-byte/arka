...
DuckDuckGo lookups दो env vars को मानते हैं। अगर हर retry पर timeout या error हो, तो chat failure लॉग करता है और reply रुकने के बजाय model knowledge से उत्तर देता है।
