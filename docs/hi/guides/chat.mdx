...
DuckDuckGo lookups दो env vars को मानते हैं। अगर web-context gathering fail हो जाए तो chat gracefully आगे बढ़ता है: timeout या बार-बार error होने पर search error लॉग होती है और reply रुकने के बजाय model knowledge से उत्तर आता है।

| Var | Default | Notes |
| --- | --- | --- |
| `DDGS_TIMEOUT` | `20` | प्रति call timeout (seconds)। न्यूनतम `5`। |
| `DDGS_RETRIES` | `2` | fallback से पहले attempts। न्यूनतम `1`। |

धीमे या अस्थिर networks पर दोनों बढ़ाएँ:
