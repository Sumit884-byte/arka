...
NL_CASES: tuple[tuple[str, str], ...] = (
    ...
    ("read file src/arka/agent/goal.py", "read_file"),
    ("show file tests/test_mcp_server.py", "read_file"),
    ...
    (
        "Edit files in the repo at /tmp/app create .gitignore and patch src/App.jsx",
        "code",
    ),
    ("check repo health", "repo_health"),
    ("show docker containers", "docker_status"),
    ("show high CPU processes", "processes"),
    ("show cpu stats", "processes"),
    ("what is using my cpu", "processes"),
    ("list top processes", "processes"),
    ...
    ("find code on twitter for asyncio", "social_code_lookup"),
    ("look for opensource observability platform", "look_for_opensource"),
    ("find open source alternative to Slack", "look_for_opensource"),
    ("search reddit for arka examples", "social_code_lookup"),
    ("social media code lookup rust error handling", "social_code_lookup"),
    ("what are people saying about asyncio on github", "social_code_lookup"),
    ...
    ("use arka mcp and improve it", "self_improve"),
    ("improve arka mcp", "self_improve"),
    ("improve mcp capabilities", "self_improve"),
    ("coding-tui .", "coding-tui"),
    ("open coding tui", "coding-tui"),
    ("start coding workspace", "coding-tui"),
    ("babysit this pr", "pr_check"),
    ("fix ci until green", "pr_check"),
    ("explain ci failure", "pr_check"),
    ("fix github issue #42", "jules"),
    ("work on issue 7 async", "jules"),
    ("jules list", "jules"),
    ...
    ("run qa on this", "qa_engineering"),
    ("qa checklist for feature login", "qa_engineering"),
    ("triage test failures", "qa_engineering"),
    ("test coverage report", "qa_engineering"),
    ("exploratory testing for checkout", "qa_engineering"),
    ("extreme constraints for checkout", "qa_engineering"),
    ("production ready constraints for checkout", "qa_engineering"),
    ("production readiness", "qa_engineering"),
    ("mutation testing plan", "qa_engineering"),
    ("verify website interactions on https://example.com", "verify_web_interaction"),
    ("test ui against component.tsx on http://localhost:3000", "verify_web_interaction"),
    ("check if site works with this code", "verify_web_interaction"),
    ("check for duplicate text", "duplicate_text"),
    ("find semantically same copy in src", "duplicate_text"),
    ("no repeating text in web/", "duplicate_text"),
    ("arka ci", "ci"),
    ("arka ci --full", "ci"),
    ("arka ci --fix", "ci"),
    ("run ci", "ci"),
    ...
    ("audit routing", "route_audit"),
    ("check developer setup", "dev_doctor"),
    ("arka api tools", "dev_tools"),
    ("observability tools", "dev_tools"),
    ("dev tools list", "dev_tools"),
    ("show developer tools", "dev_tools"),
    ...
    ("generate a 3d model from text using hugging face", "text_to_3d"),
