...
LEGACY_MODULES: dict[str, str] = {
    ...
    "arka_network_proxy": "arka.core.network_proxy",
    "arka_jsonkit": "arka.core.jsonkit",
    "arka_processes": "arka.core.processes",
    "arka_markdown_style": "arka.core.markdown_style",
    ...
    "arka_view_output": "arka.web.output_viewer",
    "arka_read_file": "arka.agent.read_file",
    ...
    "arka_skill_server": "arka.integrations.skill_server",
    ...
    "arka_oauth": "arka.integrations.arka_oauth",
    "arka_email_contacts": "arka.integrations.email_contacts",
    "arka_alert": "arka.integrations.email_alert",
    ...
    "arka_harness": "arka.integrations.harness_cli",
    ...
    "arka_ai_video": "arka.media.ai_video",
    "arka_generate_music": "arka.media.music_generate",
    "arka_local_music_gen": "arka.agent.local_music_gen",
    ...
    "arka_noise_remove": "arka.media.noise_remove",
    "arka_audio_eq": "arka.media.audio_eq",
    "arka_signoz_publish": "arka.agent.signoz_publish",
    "arka_create_video": "arka.media.create_video",
    "arka_model_video": "arka.media.model_video",
    "arka_edit_video": "arka.media.edit_video",
    "arka_dub_video": "arka.media.dub_video",
    "arka_fetch_lyrics": "arka.media.fetch_lyrics",
    "arka_safety_advice": "arka.agent.safety_advice",
    "arka_google_flow": "arka.media.google_flow",
    "arka_music_generate": "arka.media.music_generate",
    "arka_chart": "arka.charts.plot",
    "arka_chart_from_pdf": "arka.charts.chart_from_pdf",
    "arka_treemap": "arka.charts.treemap",
    "arka_bi_dashboard": "arka.agent.bi_dashboard",
    "arka_data_dashboard": "arka.agent.data_dashboard",
    "arka_unified_inbox": "arka.integrations.gmail_unified",
    "arka_gmail_summarize": "arka.integrations.gmail_email_summarize",
    "arka_gmail_auto_draft": "arka.integrations.gmail_auto_draft",
    "arka_ascii_art": "arka.agent.ascii_art",
    "arka_meme": "arka.agent.meme_templates",
    "arka_web_template": "arka.agent.web_templates",
    "arka_infographic": "arka.agent.infographic",
    "arka_reposition_image": "arka.agent.reposition_image",
    "arka_filter_images": "arka.agent.filter_images",
