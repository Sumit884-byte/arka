...
_LAZY_SKILLS: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ...
    ("processes", "arka.core.processes", ("cpu_top", "cpu-top", "high_cpu")),
    ...
    ("ponytail", "arka.agent.ponytail", ("ponytail-review", "ponytail-audit")),
    (
        "local_cloud_router",
        "arka.agent.local_cloud_router",
        (
            "route_local_or_cloud",
            "route-local-or-cloud",
            "prompt_complexity_router",
    ...
    ("audio_eq", "arka.media.audio_eq", ("audio-eq", "equalizer", "equaliser", "eq_audio")),
