...
TASK_PROFILES: dict[str, dict[str, str]] = {
    ...
    "website_pages": {
        "description": "Website IA — sitemap and page organization plans",
        "default_model": "gemini/gemini-2.5-flash",
    },
    "default": {
...
SKILL_TASK_MAP: dict[str, str] = {
    ...
    "post_x": "summarize",
    "social_code_lookup": "research",
    "look_for_opensource": "research",
    "post_devto": "summarize",
    "devto_post": "summarize",
    "project_docs": "summarize",
    "signoz_publish": "summarize",
    ...
    "day_research": "research",
    "day_research_planner": "agent",
    "day_research_executor": "summarize",
    "interval_research": "research",
